...
def show_splash_screen():
    ...
    Label(splash, text="Image Resizer Pro", font=("Helvetica", 30, "bold"), fg="#4caf50", bg="#f7f7f7").pack(expand=True)
...
def open_main_window():
    ...
    # Logo
    Label(root, text="Image Resizer Pro", font=("Helvetica", 30, "bold"), fg="#4caf50", bg=bg_color).pack(pady=10)
    ...
    Button(frame, text="Select Images", command=select_images, font=button_font, bg=button_bg, fg=button_fg).grid(row=0, column=1, padx=100, pady=5)
